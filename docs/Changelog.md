...
- Added advanced [prompt customization](#/prompt?highlight=PROMPT_SELECTOR_SECTION) with support for Auto Translation, Subtitle Translation, prompt previews, and selected system translation wrappers.
